...
function toggleProjectFavorite(myClassName) {
    $(myClassName).toggleClass("checked");
}
...
(function ($) {
    ...
    $("#new_add1").click(function () {
        ...
        html += '<label for="" class="form-label">Libellé</label>';
        html += '<input type="text" class="form-control" placeholder="Libellé">';
        html += '</div>';
        html += '<div class="col-md-2 input-block floating-icon">';
        html += '<label for="" class="form-label">Montant</label>';
        html += '<input type="text" class="form-control" placeholder="Montant">';
        html += '<span><i class="feather-dollar-sign"></i></span>';
        html += '</div>';
        html += '<div class="col-md-3 input-block floating-icon">';
        html += '<label for="" class="form-label">Date de début</label>';
        html += '<input type="date" class="form-control datetimepicker" placeholder="Date de début">';
        html += '<span><i class="feather-calendar"></i></span>';
        html += '</div>';
        html += '<div class="col-md-3 input-block floating-icon">';
        html += '<label for="" class="form-label">Date de fin</label>';
        html += '<input type="date" class="form-control datetimepicker" placeholder="Date de fin">';
        html += '<span><i class="feather-calendar"></i></span>';
        html += '</div>';
        html += '<div class="col-md-12">';
        html += '<div class="new-addd">';
        html += '<a  id="remove_row" class="remove_row"> Supprimer</a>';
        html += '</div>';
        html += '</div>';
    ...
    $(".add-edu").click(function () {
        ...
        html += '<label class="form-label">Nom de diplome</label>';
        html += '<input type="text" class="form-control" name="educations[' + edu_i + '][name]">';
        html += '</div>';
        html += '<div class="input-block col-lg-3">';
        html += '<label class="form-label">Nom de l\'université</label>';
        html += '<input type="text" class="form-control" name="educations[' + edu_i + '][university]">';
        html += '</div>';
        html += '<div class="input-block col-lg-3">';
        html += '<label class="form-label">Année de début</label>';
        html += '<input type="text" class="form-control" name="educations[' + edu_i + '][year_of_start]">';
        html += '</div>';
        html += '<div class="input-block col-lg-2">';
        html += '<label class="form-label">Année de fin</label>';
        html += '<input type="text" class="form-control" name="educations[' + edu_i + '][year_of_end]">';
        html += '</div>';
        html += '<div class="input-block col-lg-1 mb-0">';
        html += '<a href="javascript:void(0);" class="btn trash-icon delete-education"><i class="far fa-trash-alt"></i></a>';
        html += '</div>';
        html += '</div>';
    ...
    $(".add-certi").click(function () {
        ...
        html += '</div>';
        html += '<div class="input-block col-lg-1 mb-0">';
        html += '<a href="javascript:void(0);" class="btn trash-icon" data-id="-1"><i class="far fa-trash-alt"></i></a>';
        html += '</div>';
        html += '</div>';
    ...
    $(".add-exp").click(function () {
        ...
        html += '<div class="form-row align-items-center skill-cont">';
        html += '<div class="input-block col-lg-3">';
        html += '<label class="form-label">Nom de l\'entreprise</label>';
        html += '<input type="text" class="form-control" name="experiences[' + exp_i + '][company_name]">';
        html += '</div>';
        html += '<div class="input-block col-lg-2">';
        html += '<label class="form-label">Poste occupé</label>';
        html += '<input type="text" class="form-control" name="experiences[' + exp_i + '][position]">';
        html += '</div>';
        html += '<div class="input-block col-lg-3 floating-icon">';
        html += '<label  class="form-label">Date de début</label>';
        html += '<input type="date" class="form-control datetimepicker" placeholder="" name="experiences[' + exp_i + '][start_date]">';
        html += '<span hidden><i class="feather-calendar"></i></span>';
        html += '</div>';
        html += '<div class="input-block col-lg-3 floating-icon">';
        html += '<label  class="form-label">Date de fin</label>';
        html += '<input type="date" class="form-control datetimepicker" placeholder="" name="experiences[' + exp_i + '][end_date]">';
        html += '<span hidden><i class="feather-calendar"></i></span>';
        html += '</div>';
        html += '<div class="input-block col-lg-1 mb-0">';
        html += '<a href="javascript:void(0);" class="btn trash-icon delete-exp"><i class="far fa-trash-alt"></i></a>';
        html += '</div>';
        html += '</div>';
    ...
    $("#experience_add").click(function () {
        ...
        html += '<div class="col-md-6 col-lg-3">';
        html += '<div class="input-block ">';
        html += '<label class="focus-label">Nom de l\'entreprise</label>';
    ...
    $('#file').change(function () {
        ...
        // Iterate through the selected files and append them to the list
        for (var i = 0; i < fileList.length; i++) {
            var fileId = 'file_' + i; // Assign a unique identifier
            var fileName = fileList[i].name;
            var fileExtension = fileName.split('.').pop().toLowerCase();
            var iconClass = getFileIconClass(fileExtension);

            var listItem = $('<li id="' + fileId + '"><h6><i class="' + iconClass + '"></i>' + fileName + '<a href="javascript:void(0);" class="file-close" data-fileid="' + fileId + '"></a></h6></li>');
            $('#file-list').append(listItem);
        }
    });

    $('#file-list').on('click', '.file-close', function () {

        var fileId = $(this).data('fileid');
        // Remove the corresponding file from the list
        $('#' + fileId).remove();

        // You may also want to remove the corresponding file from the input field
        var fileInput = $('#file');
        ...
        fileInput[0].files = new FileList(updatedFiles);

        // Add logic to handle file removal if necessary
    ...
    function getFileIconClass(extension) {
        ...
        switch (extension) {
            case 'pdf':
                return 'far fa-file-pdf fa-2x m-2 text-muted ';
            case 'doc':
                return 'far fa-file-word fa-2x m-2 text-muted';
            case 'docx':
                return 'far fa-file-word fa-2x m-2 text-muted';
            case 'xls':
                return 'far fa-file-excel fa-2x m-2 text-muted';
            case 'xlsx':
                return 'far fa-file-excel fa-2x m-2 text-muted';
            case 'ppt':
                return 'far fa-file-powerpoint fa-2x m-2 text-muted';
            case 'pptx':
                return 'far fa-file-powerpoint fa-2x m-2 text-muted';
            case 'png':
                return 'far fa-file-image fa-2x m-2 text-muted';
            case 'jpg':
                return 'far fa-file-image fa-2x m-2 text-muted';
            case 'jpeg':
                return 'far fa-file-image fa-2x m-2 text-muted';
            case 'gif':
                return 'far fa-file-image fa-2x m-2 text-muted';
            case 'txt':
                return 'far fa-file-alt fa-2x m-2 text-muted';
            case 'zip':
                return 'far fa-file-archive fa-2x m-2 text-muted';
            case 'rar':
                return 'far fa-file-archive fa-2x m-2 text-muted';
            case 'webp':
                return 'far fa-file-image fa-2x m-2 text-muted';
            case 'web':
                return 'far fa-file-code fa-2x m-2 text-muted';
            default:
                return 'far fa-file fa-2x m-2 text-muted';
        }
    }
