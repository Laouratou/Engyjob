            ...
            <div class="col-xl-9 col-lg-8">
                <div class="dashboard-sec">
                    <div class="page-title">
                        <h3>Tableau de bord
                            <span class="text-light bg-primary-light p-1 m-2 rounded h6 fw-medium">Freelancer</span>
                        </h3>
                    </div>
                    <div class="row">
                    ...
                    <script>
                        // Définir une variable JavaScript avec les informations de l'utilisateur
        var userType = '{{ $user->type }}'; // Supposons que vous ayez un champ 'type' dans votre modèle User
                    </script>
                    <!-- Chart Content -->
                    <div class="row">
