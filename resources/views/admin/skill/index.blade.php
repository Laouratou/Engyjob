                                    ...
                                    <tbody>
                                        @foreach ($skills as $key => $skill)
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_blank" href="{{ url($skill->image) }}">
                                                ...
                                                <td class="text-end">
                                                    {{-- <a href="javascript:void(0);" class="btn btn-sm btn-secondary me-2"
                                                        data-bs-toggle="modal" data-bs-target="#edit-skill"><i
                                                            class="far fa-edit"></i></a> --}}
                                                    <button class="btn btn-sm @if (!$skill->is_active)
                                                        btn-danger
                                                    @else
                                                        btn-success
                                                    @endif toggleActive"
                                                        data-model="Skill" data-id="{{ $skill->id }}">
