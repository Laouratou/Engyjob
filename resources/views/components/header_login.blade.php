    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg header-nav p-0">
            ...
            <ul class="nav header-navbar-rht reg-head">
                <li><a href="register.html" class="reg-btn"><img src="{{ asset('assets/img/icon/users.svg') }}"
                            class="me-1" alt="img">Register</a></li>
                <li><a href="login.html" class="log-btn active"><img src="{{ asset('assets/img/icon/lock.svg') }}"
