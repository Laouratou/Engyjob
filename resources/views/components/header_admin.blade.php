<div class="header">
    ...
    <ul class="nav user-menu">
                        ...
                        <li class="notification-message">
                            <a href="javascript:void(0);">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body flex-grow-1">
                                        <p class="noti-details"><span class="noti-title">Barbara Moore</span> declined
                                            the invoice <span class="noti-title">#RDW026896</span></p>
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
                  @if(auth()->user()->profil && auth()->user()->profil->photo)
    <img src="{{ asset(auth()->user()->profil->photo) }}" alt="Image">
@else
    <img src="{{ asset('path/vers/une/image/par/defaut.jpg') }}" alt="Image par défaut">
@endif
