...
@section('content')
                                ...
                                <div class="col-xl-9 col-lg-8">
                                        ...
                                        <nav class="user-tabs mb-4">
                                                <ul class="nav nav-tabs nav-tabs-bottom nav-justified">
                                                        <li class="nav-item">
                                                                <a class="nav-link active" href="{{ route('company.projects.details', $project->id) }}">Aperçu
                                                                        & Discussions</a>
                                                        </li>
                                                        <li class="nav-item">
                                                                <a class="nav-link" href="{{ route('company.projects.manage_etape_cles', $project->id) }}">
                                                                        Etapes clés
                                                                </a>
                                                        </li>
                                                        <li class="nav-item">
    ...
    @if ($reviews->isNotEmpty())
        @php
            $totalRating = $reviews->sum('rate'); // Utilisation de sum pour simplifier
...
@endif
                                        ...
                                        <div class="proposals-section mb-4">
                                                <h4 class="page-subtitle">Les meilleures propositions</h4>

                                                @forelse ($sticky_proposals as $proposal_sticky)
                                                        <div class="project-proposals align-items-center">
                                                                <div class="proposals-info">
                                                                        <div class="proposer-info">
                                                                                <div class="proposer-img">
                                                                                        <img src="{{ asset($proposal_sticky->user->profil->photo) }}" alt="Img"
                                                                                                class="img-fluid">
                                                                                </div>
                                                                                <div class="proposer-detail">
                                                                                        <h4>{{ $proposal_sticky->user->name }}
                                                                                                {{ $proposal_sticky->user->first_name }}</h4>
                                                                                        <ul class="proposal-details">
                                                                                                <li> {{ \Carbon\Carbon::parse($proposal_sticky->created_at)->diffForHumans() }}
                                                                                                </li>
                                                                                                <li><i class="fas fa-star text-primary"></i> 5.0</li>
                                                                                                <li>
                                                                                                        <a href="{{ route('freelancers.profile', $proposal_sticky->user->id) }}"
                                                                        ...
                                                                        <div class="proposer-bid-info">
                                                                                <div class="proposer-bid">
                                                                                        <h3>{{ number_format($proposal_sticky->price ?? 0, 0, ',', ' ') }} CFA
                                                                                                @if ($proposal_sticky->project->budget_type == 'hourly')
                                                                                                        /heure
                                                                                                @endif
                                                                                        </h3>

                                                                                        <h5>
                                                                                                En {{ $proposal_sticky->number_delivery_days }} jours
                                                                                        </h5>
                                                                                </div>
                                                                                <div class="proposer-confirm">
                                                                                        @if ($project->freelancer_id == null)
                                                                                                <button type="button" id="" class="projects-btn openHireModalBtn"
                                                                                                        data-id="{{ $proposal_sticky->id }}"
                                                                                                        data-freelancer_id="{{ $proposal_sticky->user_id }}"
                                                                                                        data-project_id="{{ $proposal_sticky->project_id }}"
                                                                                                        data-freelancer_name="{{ $proposal_sticky->user->name }} {{ $proposal_sticky->user->first_name }}">
                                                                                                        Embaucher
                                                                                                </button>
                                                                                        @endif
                                                                                </div>
                                                                ...
                                                                <div class="description-proposal">
                                                                        ...
                                                                        <p>{!! Str::substr($proposal_sticky->letter_cover, 0, 400) !!}
                                                                                <span id="dots">...</span>
                                                                                <span id="more"> {!! Str::substr($proposal_sticky->letter_cover, 400, strlen($proposal_sticky->letter_cover) - 400) !!}
                                                ...
                                                <hr class="my-4">
                                                <h4 class="page-subtitle">Autres propositions</h4>
                                                        ...
                                                        <div class="project-proposals align-items-center">
                                                                <div class="proposals-info">
                                                                        ...
                                                                        <div class="proposer-bid-info">
                                                                                ...
                                                                                <div class="proposer-confirm">
    @if ($project->freelancer_id == null)
        <form action="{{ route('company.projects.hire_freelancer') }}" method="POST">
            @csrf
            ...
            <button type="submit" class="projects-btn">
                Embaucher
            </button>
        </form>
    @endif
                                                                ...
                                                                <div class="description-proposal">
                                                                        ...
                                                                        <p>{!! Str::substr($proposal->letter_cover, 0, 400) !!}
                                                                                ...
                                                                                </span><span id="myBtn" class="text-primary font-bold readmore">Lire
                                                                                        plus</span>
                                                                        </p>
                                                                </div>
                                                        </div>
